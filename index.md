...
- **It accurately reconstructs linear dynamic processes.** The
  performance was evaluated using a quantitative evaluation pipeline and
...
- Running SCORPIUS on an AnnData object:  
  [`vignette("anndata", package="SCORPIUS")`](rcannood.github.io/SCORPIUS/articles/anndata.md)
- Investigating dendritic cell maturation in dendritic cell
  progenitors:  
  [`vignette("ginhoux", package="SCORPIUS")`](rcannood.github.io/SCORPIUS/articles/ginhoux.md)
- Running SCORPIUS on a Seurat object:  
  [`vignette("seurat", package="SCORPIUS")`](rcannood.github.io/SCORPIUS/articles/seurat.md)
- Trajectory inference from simulated data:  
  [`vignette("simulated-data", package="SCORPIUS")`](rcannood.github.io/SCORPIUS/articles/simulated-data.md)
...
![](reference/figures/README_reduce_dimensionality-1.png)
...
![](reference/figures/README_infer_trajectory-1.png)
...
![](reference/figures/README_visualise_tafs-1.png)
...
![](reference/figures/README_moduled_tafs-1.png)
